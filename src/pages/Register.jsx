...
function Register() {
    ...
    //fucntion to handle the register 
    ...
    return (
        ...
        <div style={{ backgroundImage: "url('/night.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <main className="w-full h-screen flex self-center place-content-center place-items-center">
            <div className="w-96 text-white space-y-5 p-4  shadow-xl border rounded-xl">
                ...
                >
                    ...
                    <div>
                        <label className="text-sm white font-bold">
                            Confirm Password
                        </label>
                        <input
                            disabled={isRegistering}
